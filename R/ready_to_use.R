...
ru_canale <- function(scales_variables_modules, region_DA_IDs, crs) {
  ba_var(
    ...
    module_dataset_info = paste0(
      ...
      " a 1km buffer around the centroid of dissemination areas. This provide",
      "s a more accurate representation of walkable areas. Our index also dif",
      "fers by using a sum of percentiles rather than a sum of z-indexes. Thi",
      "s method reduces the influence of extreme outliers, especially in the ",
      "case of points of interest. For example, an area with an exceptionally",
      " high number of points of interest doesn't necessarily translate into ",
      "it being vastly more walkable. There's a threshold at which the additi",
      "on of more points of interest doesn't significantly enhance the active",
      " living potential of an area. Thus, our percentile approach provides a",
      " more balanced and nuanced understanding of an area's walkability."
    ),
