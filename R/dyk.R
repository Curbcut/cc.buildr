...
#' @export
dyk_uni <- function(vars_dyk, svm, langs, translation_df) {
...
#' @export
dyk_uni_highest_lowest <- function(var_left, region, scale, date, svm, langs) {
  ...
  lowest <- dyk_assemble_lowest(
    ...
    lowest_val, second_lowest_name, second_lowest_val, langs)
