...
if (length(main_card_outliers) > 4) main_card_outliers[1:4] <- main_card_outliers[1:4]
...
if (length(main_card_normal) > 4) main_card_normal[1:4] <- main_card_normal[1:4]
...
main_card <- bslib::nav(
    ...
    htmltools::br(),
    htmltools::h3("What makes this area unique?"),
    bslib::card_body_fill(main_card_outliers),
    htmltools::h3("What makes this area similar to others?"),
    bslib::card_body_fill(main_card_normal)
